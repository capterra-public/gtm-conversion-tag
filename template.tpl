...

{
  ...
  "description": "Use this tag to track conversions on key pages in your buyer experience. This can be loaded on a thank you page, after a conversion happens, or during the conversion form submission.",
  "containerContexts": [
    "WEB"
  ]
}
