...

{
  ...
  "description": "Use this tag to track conversions on thank you pages or during the conversion form submission. The \"G2DM - Universal Script\" tag must be installed in all your pages for this to work.",
  "containerContexts": [
    "WEB"
  ]
}
